...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, nargs='+', default=["../dataset/agent_rl.jsonl"], help="训练数据路径（支持多个文件/目录）")
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        rl_train_epoch(epoch, loader, iters, rollout_engine, ref_model, reward_model, start_step, wandb, use_sglang=(args.rollout_engine == "sglang"))
